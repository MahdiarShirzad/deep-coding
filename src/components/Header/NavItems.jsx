...
const NavItems = () => {
  ...
  return (
    <div className=" max-lg:pt-10">
      <div className=" absolute -top-16 left-4 lg:hidden">
      ...
      <ul className="flex flex-col relative lg:flex-row w-full text-#1A064F] transition-none items-center h-full gap-10 pr-12">
