...
import logo from "../../assets/images/general/logo-black.svg";
import { NavLink } from "react-router-dom";

const UnScrolledHeader = () => {
  return (
    <div className=" absolute top-0 right-0 left-0 bg-transparent text-white">
      <div className="container max-w-[1320px] flex mx-auto items-center py-4 font-iransans pr-6">
        ...
        <div className="flex items-center justify-between w-96">
          ...
          <button>ورود</button>
          <button className=" text-[#1A064F] bg-white rounded-xl px-9 py-3 border-2 border-white hover:bg-transparent hover:text-[#fff]">
            ثبت نام
          </button>
        </div>
      </div>
...
export default UnScrolledHeader;
