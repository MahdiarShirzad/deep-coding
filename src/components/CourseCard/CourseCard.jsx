...
const CourseCard = ({ posts }) => {
  ...
  // teacher ممکنه object باشه (populate شده) یا string (ObjectId)
    ...
    <Link to={`/courses/${slug || _id}`} onClick={scrollToTop}>
      <div className={styles.card_section} data-aos="fade-left">
        <div className={`${styles.card_item} ${styles.card_users}`}>
          <div className="w-[300px] h-[455px] mb-8 px-4 py-5 rounded-xl shadow-sm shadow-gray-200">
