    ...
    <Link to={`/courses/${_id}`} onClick={scrollToTop}>
      <div className={styles.card_section}>
        <div className={`${styles.card_item} ${styles.card_users}`}>
          {/* تغییر کانتینر اصلی برای ریسپانسیو شدن */}
          <div className="w-full h-auto flex flex-col md:flex-row md:h-44 font-iransans gap-4 md:gap-8 rounded-2xl p-4 md:px-6 md:py-4 shadow-sm shadow-slate-300">
            <div className="w-full h-48 md:w-52 md:h-full">
              {" "}
            ...
            <div className="w-full md:w-3/5 flex flex-col justify-between">
              {" "}
              {/* ریسپانسیو کردن کانتینر متن */}
              <div>
                <h3 className="text-lg md:text-xl font-medium mb-2 mt-1 md:mb-3 md:mt-2">
                  {" "}
                  {/* کوچک کردن فونت و اصلاح h3 تکراری */}
                  {name.length > 28 ? name.slice(0, 28) + "..." : name}
                </h3>
                <p className="flex items-center gap-1 text-gray-500 text-sm md:text-base mb-2">
                  {" "}
                  {/* ریسپانسیو کردن فونت */}
                ...
                <div className="flex items-center gap-3 md:gap-5 mb-2 text-xs md:text-sm">
                  {" "}
                  {/* ریسپانسیو کردن فونت و گپ */}
                  <p className="flex items-center justify-center text-gray-500 gap-1">
                    <svg
                  ...
                  <p className="flex items-start text-gray-500 gap-1">
                    <img className="w-4 md:w-5" src={levelsvg} alt="" />
                    <span>{level}</span>
                  </p>
                </div>
              </div>
