      ...
      {isLoading ? (
        ...
        <div className="flex items-start justify-between mt-24 gap-8">
          ...
          <div className="w-4/5 max-lg:mx-auto max-lg:w-full">
            ...
            <div>
              <div className="min-h-[700px] flex items-start justify-start lg:gap-5 max-xl:justify-between max-xl:px-32 max-md:mt-16 px-5 flex-wrap mt-7 max-lg:justify-center max-lg:gap-12 max-xl:mx-auto">
