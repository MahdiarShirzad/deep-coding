...
const SidebarPanel = () => {
  ...
  return (
    <ul className="w-[295px] bg-slate-900 text-white px-5 py-3 flex flex-col gap-5 rounded-md">
      ...
      <NavLink to="/user-panel/cart-info" className={activeClass}>
