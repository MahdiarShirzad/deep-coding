...
const UserStats = () => {
  return (
    <div className=" w-full flex gap-8 h-[150px]">
      <div className=" w-[290px] bg-orange-100 flex items-center justify-center py-6 gap-3 rounded-lg">
        <svg
          className=" w-[110px]"
          viewBox="0 0 24 24"
          fill="none"
        ...
        <div className=" flex gap-2 text-lg text-orange-800">
          <p className=" font-bold text-xl">9</p>
          <p>دوره</p>
        </div>
      </div>
      <div className=" w-[290px] bg-purple-100 flex items-center justify-center py-6 gap-3 rounded-lg">
        <svg
          className=" w-[110px]"
          viewBox="0 0 24 24"
          fill="none"
